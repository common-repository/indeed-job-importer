...
3. screenshot-2.png  : screen shot admin Bitly Short URL Setting.


== Changelog ==

= 1.0.5 =
* Add  default indeed logo in dispaly template

= 1.0.4 =
* Add  channel option
* Add  job_detail_more_link_onmousedown macro support in Display Template
* Fix  Warning

= 1.0.3 =
* Add Bitly short url macro support in Display Template
* Add More country in country drop down
